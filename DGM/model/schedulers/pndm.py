...
class PNDMScheduler(Scheduler):
    ...
    def __init__(self, skip_prk_steps: bool = False, set_alpha_to_one: bool = False, steps_offset: int = 0, **kwargs) -> None:
        super().__init__(**kwargs)
        if self.prediction_type.lower() not in ["epsilon", "v_prediction"]:
        ...
        self._timesteps = np.arange(0, self.num_train_timesteps)[::-1].copy()
